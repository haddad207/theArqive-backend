# Generated by Django 3.0.5 on 2020-04-23 22:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='tag',
            name='pinId',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='taags', to='pins.pin'),
        ),
        migrations.AddField(
            model_name='pin',
            name='category',
        ...
        migrations.AddField(
            model_name='pin',
            name='tags',
            field=models.ManyToManyField(blank=True, to='pins.Tag'),
        ),
        migrations.AddField(
            model_name='photo',
            name='uploader',
